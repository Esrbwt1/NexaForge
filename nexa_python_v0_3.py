...
def extract_features(node):
    features = [0, 0, 0, 0, 0, 0]  # [size, has_if, additions, depth, unrollable, vectorizable]
...
X_train = np.array([
    [1000000, 1, 1, 1, 0, 1],  # Big, vectorize
    [10, 0, 0, 1, 1, 0],       # Tiny, unroll
    [1000, 1, 0, 1, 0, 0],     # Medium, sum
    [500000, 1, 1, 1, 0, 1],   # Big, vectorize
    [50, 1, 1, 1, 1, 0]        # Small, unroll
])
