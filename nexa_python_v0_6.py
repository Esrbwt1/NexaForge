...
def extract_features(node):
    ...
    if isinstance(node, ast.For):
        if isinstance(node.iter, ast.Call) and node.iter.func.id == 'range':
            ...
            features[7] = 1 if features[0] >= 100000000 else 0  # Thread at 100M+
        features[3] = 1
...
"""
        ...
        if limit >= 100000000:  # Thread at 100M+
            return f"""
def fast_code():
...
if __name__ == '__main__':
    ...
    # Test NexaScript
    nexa_script = "NEXASCRIPT: PARALLEL(10000000)"
